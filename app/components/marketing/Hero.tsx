...
export default function Hero() {
  return (
    <section className="px-6 pt-20 text-center md:px-0 md:pt-0">
      <div className="mx-auto inline-flex rounded-full bg-emerald-100 px-6 py-2">
        <span className="text-xs uppercase tracking-wide md:tracking-wider text-emerald-800 lg:text-sm">
          Autonomous Commerce
        </span>
      </div>
